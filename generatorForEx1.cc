...
/*
  ...
  % g++ -std=c++11 generatorForEx1.cc

  #Index
  in1-1: 全て評価済、限界値(ユーザ数=100, 書籍数=100)
  in1-2: 一定の割合で-1を出力
  in1-3: ある1冊だけ全て未評価
  in1-4: ある1人だけ全て未評価
 */
...
int main() {
  EvaluatedOnly( "in1-1", 100, 100 );
  Mixed( "in1-2", 10, 15, 10 );
  UnevaluatedColumn( "in1-3", 10, 15, 3 );
  UnevaluatedUser( "in1-4", 10, 15, 1);
  //EvaluatedOnly( "", 2, 1 );
